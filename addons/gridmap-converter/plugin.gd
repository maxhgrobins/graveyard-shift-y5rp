...
func _enter_tree():
	...
	add_control_to_container(CONTAINER_SPATIAL_EDITOR_MENU, container)
	...
	print("Plugin Loaded: Container is ", container)
	container.show()
...
func _exit_tree():
	...
	remove_control_from_container(CONTAINER_SPATIAL_EDITOR_MENU, container)
